    ...
    },
    {
        ...
        ingredients: [
            ...
            },
            {
                ...
                amount: '1汤匙 / 1 tbsp',
                substitution: { zh: '可用更多生抽代替', en: 'More light soy sauce can be used' }
            },
            {
    ...
    },
    {
        ...
        ingredients: [
            ...
            },
            {
                name: { zh: '老抽', en: 'Dark soy sauce' },
                amount: '1汤匙 / 1 tbsp',
                substitution: { zh: '可用更多生抽代替，但颜色会浅一些', en: 'Can use more light soy sauce, but color will be lighter' }
            },
            {
                name: { zh: '冰糖', en: 'Rock sugar' },
                amount: '10克 / 10g',
...
function renderRecipesPage() {
    const filteredRecipes = currentScenario 
        ? recipes.filter(recipe => recipe.scenario === currentScenario)
        : recipes;
